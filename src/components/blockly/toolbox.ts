...
const categoryBlocks = {
  ...
  movement: [
    ...
    },
    {
      ...
      fields: { DRONE_ID: 1, DIRECTION: "forward", DISTANCE: 1 },
    },
    {
      kind: "block",
      type: "drone_move_xyz",
      fields: { DRONE_ID: 1, X: 0, Y: 0, Z: 0, SPEED: 2 },
    },
    {
      kind: "block",
      type: "drone_rotate",
      fields: { DRONE_ID: 1, DIRECTION: "CW", DEGREES: 90 },
    },
  ],
  ...
  rc: [
    {
      ...
      fields: { DRONE_ID: 1, ROLL: 0, PITCH: 0, YAW: 0, THROTTLE: 0 },
    },
  ],
  ...
  mission: [
    {
      ...
      fields: { X: 0, Y: 0, Z: 2, SPEED: 2, HOLD_TIME: 0 },
    },
    {
      kind: "block",
      type: "mission_goto_waypoint",
      fields: { WAYPOINT_INDEX: 1, SPEED: 2 },
    },
  ...
  settings: [
    {
      ...
      fields: { DRONE_ID: 1, SPEED: 2 },
    },
  ],

  // 7. 동기화 & 대기
  sync: [{ kind: "block", type: "control_wait", fields: { DURATION: 2 } }],
