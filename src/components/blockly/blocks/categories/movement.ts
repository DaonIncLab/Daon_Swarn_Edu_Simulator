...
export function registerMovementBlocks() {
  ...
  Blockly.Blocks["drone_move_direction"] = {
    init: function () {
      ...
      this.setColour(160);
      this.setTooltip("현재 위치 기준으로 지정한 방향으로 이동합니다.");
      this.setHelpUrl("");
    },
  };
  ...
  Blockly.Blocks["drone_move_direction_all"] = {
    init: function () {
      ...
      this.setNextStatement(true, null);
      this.setColour(160);
      this.setTooltip("모든 드론을 현재 위치 기준으로 상대 이동시킵니다.");
      this.setHelpUrl("");
    },
  };
  ...
  Blockly.Blocks["drone_move_xyz"] = {
    init: function () {
      ...
      this.setNextStatement(true, null);
      this.setColour(160);
      this.setTooltip("속도는 설정 블록으로 관리하고, 이동은 위치/방향만 담당합니다.");
      this.setHelpUrl("");
    },
  };
