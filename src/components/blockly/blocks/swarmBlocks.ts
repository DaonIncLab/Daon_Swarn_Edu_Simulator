...
Blockly.Blocks["drone_move_direction_all"] = {
  init: function () {
    ...
    this.setColour(160);
    this.setTooltip(
      "모든 드론을 현재 위치에서 지정된 방향으로 상대 이동시킵니다\nMAVLink: SET_POSITION_TARGET_LOCAL_NED",
    );
    this.setHelpUrl("");
  },
};
...
Blockly.Blocks["drone_move_xyz"] = {
  init: function () {
    ...
    this.setColour(160);
    this.setTooltip(
      "드론을 현재 위치에서 XYZ 방향으로 상대 이동시킵니다 (현재 위치 기준)\nMAVLink: SET_POSITION_TARGET_LOCAL_NED",
    );
    this.setHelpUrl("");
  },
};
...
Blockly.Blocks["mission_add_waypoint"] = {
  init: function () {
    this.appendDummyInput().appendField("📍 웨이포인트 추가");
    this.appendDummyInput()
      .appendField("X:")
...
Blockly.Blocks["mission_execute"] = {
  init: function () {
    this.appendDummyInput().appendField("🚀 미션 실행");
    this.appendDummyInput()
      .appendField("반복")
...
Blockly.Blocks["mission_clear"] = {
  init: function () {
    this.appendDummyInput().appendField("🗑️ 미션 초기화");
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(60);
